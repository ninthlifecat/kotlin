...
internal class FirLightAnonymousClassForSymbol(private val classOrObjectSymbol: KtClassOrObjectSymbol,
                                               manager: PsiManager
    ...
    override fun equals(other: Any?): Boolean =
        this === other ||
                (other is FirLightAnonymousClassForSymbol && classOrObjectSymbol == other.classOrObjectSymbol)

    override fun hashCode(): Int = classOrObjectSymbol.hashCode()

    override fun copy() =
        FirLightAnonymousClassForSymbol(classOrObjectSymbol, manager)
